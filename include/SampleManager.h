...
public:
	...
	std::vector<std::string> collect_imputed_samples(
						const std::vector<const KnownFamily *>& families) const;
	...
	std::vector<const Progeny *>
		extract_one_imputed_and_non_imputed_progenies(const Family *f) const;
	std::vector<const KnownFamily *>
					extract_parent_and_progeny_imputed_families() const;
	...
	std::vector<const KnownFamily *> extract_progenies_imputed_families() const;
	std::vector<const KnownFamily *>
						extract_parent_known_progenies_imputed_families() const;
