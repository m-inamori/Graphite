#ifndef __VCFCLIPPABLE
#define __VCFCLIPPABLE
...
class VCFClippable : public VCFGenoBase, public VCFMeasurable {
public:
	VCFClippable(const STRVEC& s, const Map& map_, const VCFSmall *vcf) :
									VCFGenoBase(s, vcf), VCFMeasurable(map_) { }
	virtual ~VCFClippable() { };
