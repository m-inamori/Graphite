...
public:
	Option(const std::string& vcf, const std::string& ref,
			...
			double pr, bool ii, bool ci, bool ou, const std::string& out) :
...
private:
	...
	static std::string flags_value(const std::string& short_key,
							const std::string& long_key, int argc, char **argv);
	...
	static double get_precision_ratio(int argc, char **argv);
};
