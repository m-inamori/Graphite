...
int main(int argc, char **argv) {
	const string	seq = "";
	const vector<char>	hidden_states = {'0', '1'};
	const vector<char>	states = {'0', '1', 'N'};
	vector<map<pair<char,char>,double>>	Ts;
	for(auto p = seq.begin(); p != seq.end(); ++p) {
		map<pair<char,char>,double>	dic;
		dic[pair<char,char>('0', '0')] = 0.999;
		dic[pair<char,char>('0', '1')] = 0.001;
		dic[pair<char,char>('1', '0')] = 0.001;
		dic[pair<char,char>('1', '1')] = 0.999;
		Ts.push_back(dic);
	}
	cout << BaumWelch::impute(seq, hidden_states, states, Ts) << endl;
}
*/
